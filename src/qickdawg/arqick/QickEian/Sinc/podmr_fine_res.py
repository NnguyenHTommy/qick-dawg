'''
ODMR Fine Resolution -- Sinc pulse
=======================================================================
...
change is the pulse envelope: a sinc,
sin(pi x)/(pi x), stretched self-similarly to the pulse duration.
...
class PODMRFineRes(ReadoutHelpers, NVAveragerProgram):
    '''
    Pulsed-ODMR with a Sinc fine-resolution MW pulse.
    ...
    def initialize(self):
        ...
        # Configure Sinc pi pulse waveform
        ...
        data[:self.cfg.mw_pi_ftsamp] = sinc_envelope(self.cfg.mw_pi_ftsamp)
