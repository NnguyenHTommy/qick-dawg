'''
Subnanosecond Hahn Echo -- Sinc pulse
=======================================================================
pi/2_X - tau - pi_X - tau - pi/2_X with fine timed delays.

Ported from the square-pulse hahn_echo_fine_res.py with Sinc pi and
...
class HahnEchoFineRes(ReadoutHelpers, NVAveragerProgram):
    ...
    def initialize(self):
        ...
        pi_env = sinc_envelope(self.cfg.mw_pi2_ftsamp * 2)
        half_pi_env = sinc_envelope(self.cfg.mw_pi2_ftsamp)
