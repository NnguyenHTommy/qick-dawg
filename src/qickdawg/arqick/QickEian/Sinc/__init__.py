'''
Sinc-pulse fine timing suite -- fully self-contained file set.

Every experiment file carries its own sinc_envelope() definition and
...
Install as a package: copy this folder into your qickdawg package as
    qickdawg/finetimingsuite/sinc/
so the notebook imports
    from qickdawg.finetimingsuite.sinc.podmr_fine_res import PODMRFineRes
resolve.

Contents:
    podmr_fine_res.py      -- PODMRFineRes (frequency sweep, sinc pulse)
