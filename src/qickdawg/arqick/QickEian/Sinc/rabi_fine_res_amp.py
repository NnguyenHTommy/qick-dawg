'''
Amplitude (gain) Rabi -- Sinc pulse
=======================================================================
...
only change is the pulse envelope: a sinc,
...
class RabiGainFineRes(ReadoutHelpers, NVAveragerProgram):
    '''
    Amplitude (gain) Rabi with a Sinc fine-resolution MW pulse.
    ...
    def initialize(self):
        ...
        # ---------------------
        # Waveform Set-up (fixed duration, fine-resolution) -- ONE Sinc
