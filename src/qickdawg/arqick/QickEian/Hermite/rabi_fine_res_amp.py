'''
Amplitude (gain) Rabi -- Hermite pulse
=======================================================================
...
only change is the pulse envelope: a 2nd-order Hermite-Gaussian,
...
class RabiGainFineRes(ReadoutHelpers, NVAveragerProgram):
    '''
    Amplitude (gain) Rabi with a Hermite fine-resolution MW pulse.
    ...
    def initialize(self):
        ...
        # ---------------------
        # Waveform Set-up (fixed duration, fine-resolution) -- ONE Hermite
