'''
Duration-sweep Rabi -- Gaussian pulse (Python-side sweep)
=======================================================================
...
yields a square wave. Truncating a Gaussian pulse does NOT yield the same
...
requested duration it builds a self-similar Gaussian envelope (the shape
