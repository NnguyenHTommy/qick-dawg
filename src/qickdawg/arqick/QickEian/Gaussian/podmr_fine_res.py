'''
ODMR Fine Resolution -- Gaussian pulse
=======================================================================
...
change is the pulse envelope: a Gaussian,
...
class PODMRFineRes(ReadoutHelpers, NVAveragerProgram):
    '''
    Pulsed-ODMR with a Gaussian fine-resolution MW pulse.
    ...
    def initialize(self):
        ...
        # Configure Gaussian pi pulse waveform
        ...
        data[:self.cfg.mw_pi_ftsamp] = gaussian_envelope(self.cfg.mw_pi_ftsamp)
