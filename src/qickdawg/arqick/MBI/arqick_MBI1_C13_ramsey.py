'''
C13 MBI with 1 MBI and then electron spin ramsey
'''
...
class C13MBI_electron_ramsey(StandardOps, NVAveragerProgram):
    ...
    def body(self):
        ...
        # wait for readout
        self.tdds_offset_register.set_to(self.tdds_offset_register, '+', self.cfg.C13_measurement_delay_tdds +  self.pi_len_unused_tdds - self.half_pi_len_unused_tdds + self.pi_to_pi2_correction_tdds - self.pi2_to_pi2_correction_tdds)
