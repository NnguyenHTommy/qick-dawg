'''
CPMG sub-nanosecond resolution pulsing program
=======================================================================
Min resolution of 200ps for delay steps between pulses in CPMG sequence
...
class CPMGFineRes(NVAveragerProgram):
    '''
    CPMG (spin echo for N=1) sub-nanosecond resolution pulsing program
    '''
    required_cfg = [        
        ...
        "n_cpmg", # number of cpmg rounds >1
    ...
    def initialize(self):
        self.check_cfg()
        assert self.cfg.n_cpmg > 0, "N=0 will not work for this program, use the Ramsey program instead"
        # Get mw registers
