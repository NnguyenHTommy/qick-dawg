...
=======================================================================
Min resolution of 200ps for delay steps between pulses in PulsePol - Disentanglement sequence
using fine control of waveform start address and phase.
Sequence: [(pi/2_X - tau - pi_Y - tau - pi/2_X - pi/2_Y - tau - pi_X - tau -pi/2_Y) x 2Npol]- [Green - pi_X - 2Npol4tau]
'''
...
class PulsePolDisentanglementFineRes(NVAveragerProgram):
    '''
    PulsePol sub-nanosecond resolution pulsing program
    '''
    required_cfg = [
    ...
    def body(self):
        ...
        # 9. τ_green - π pulse - τ_2Npol4τ
        self.sync_all(self.cfg.delay_green_tdds)
        self.program_last_pitau(type="pi", phase=0)
    ...
    def program_last_pitau(self, type="pi", phase=0):
        self.tdds_offset_register.set_to(self.tdds_offset_register, '+', (2 * (4*self.delay_register) * self.cfg.n_pulsepol))
