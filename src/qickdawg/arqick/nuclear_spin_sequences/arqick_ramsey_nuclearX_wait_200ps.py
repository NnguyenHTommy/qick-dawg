'''
Nuclear Ramsey wait pulsing program
===================================================================
...
class NuclearRamseyWaitFineResX(StandardOps, NVAveragerProgram):
    '''
    Nuclear Ramsey wait pulsing program with sub-nanosecond resolution for <X> basis readout
    '''
    ...
    def body(self):
        ...
        # wait RZ(pi/2)
        self.tdds_offset_register.set_to(self.tdds_offset_register, '+', self.cfg.delay_tdds_gate_rzpi2)

        # e-n CROTX(pi/2)
        self.cpmg_xy8_gate(gate_index=2, pi_2_pulse_before=True, delay_tau_tdds=self.cfg.delay_tdds_gate_crxpi2, n_cpmg_pulses=self.cfg.n_cpmg_gate_crxpi2)
