...
class NuclearRamseyFineResZ(NVAveragerProgram):
    '''
    Nuclear Ramsey pulsing program with sub-nanosecond resolution for <Z> basis readout
    '''
    ...
    def body(self):
        ...
        # e-n CROTX(pi/2)
        self.tdds_offset_register.set_to(self.tdds_offset_register, '+', self.cfg.delay_tdds_ramsey - self.cfg.delay_tdds_gate_crxpi2)
        self.cpmg_xy8_gate(gate_index=5, pi_2_pulse_before=False, delay_tau_tdds=self.cfg.delay_tdds_gate_crxpi2, n_cpmg_pulses=self.cfg.n_cpmg_gate_crxpi2)
