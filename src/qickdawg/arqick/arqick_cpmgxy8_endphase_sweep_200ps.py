...
class CPMGXY8EndPhaseFineRes(NVAveragerProgram):
    '''
    CPMG XY8 sub-nanosecond resolution pulsing program with end phase sweep
    '''
    required_cfg = [        
    ...
    def initialize(self):
        ...
        # phase sequence loop register for CPMG XY pulses
        ...
        # Set up register for storing delay
        self.delay_register = self.new_gen_reg(self.cfg.mw_channel,
                                            name='delay',
                                            init_val=self.cfg.delay_tdds - self.pi_len_unused_tdds)
        
        self.end_phase_register = self.new_gen_reg(self.cfg.mw_channel,
                                            name='end_phase',
                                            init_val=self.cfg.end_phase_start_preg)
