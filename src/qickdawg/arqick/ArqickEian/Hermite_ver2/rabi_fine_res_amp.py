'''
Amplitude (gain) Rabi -- Hermite pulse -- ARQICK (ARTIQ+QICK) variant
=======================================================================
Same on-chip live-register gain sweep as the QICK-only Hermite
RabiGainFineRes: one fixed-duration Hermite envelope, gain swept via
...
class RabiGainFineRes(NVAveragerProgram):
    '''
    Amplitude (gain) Rabi with a Hermite fine-resolution MW pulse (ARTIQ-triggered readout)
    '''
    required_cfg = [
        "mw_channel",
    ...
    def initialize(self):
        ...
        # Single Hermite envelope at the fixed duration -- amplitude comes
