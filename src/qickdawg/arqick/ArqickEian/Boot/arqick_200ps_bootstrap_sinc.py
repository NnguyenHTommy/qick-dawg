'''
Bootstrap sub-nanosecond resolution pulsing program -- Sinc pulse
=======================================================================
...
of the composite pulse_seq envelope is filled with a self-similar Sinc
shape (stretched to that segment's own length) instead of a flat block, so
every sub-pulse in the sequence gets a proper Sinc envelope.
'''
...
class BootstrapFineRes(NVAveragerProgram):
    '''
    Bootstrap sub-nanosecond resolution pulsing program -- Sinc pulse shape.
    '''
    required_cfg = [        
