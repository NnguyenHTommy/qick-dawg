'''
CPMG-XY Fine-Resolution Pulse Sequence -- Sinc pulse -- ARQICK variant
=======================================================================
Same XY8 phase-cycled CPMG machinery as the QICK-only Sinc
...
class CPMGXYFineRes(NVAveragerProgram):
    ...
    def initialize(self):
        """
        Prepare Sinc pi/pi2 waveforms (one per sub-clock offset), FPGA
        ...
        pi_env = sinc_envelope(self.cfg.mw_pi2_tdds * 2)
        half_pi_env = sinc_envelope(self.cfg.mw_pi2_tdds)
