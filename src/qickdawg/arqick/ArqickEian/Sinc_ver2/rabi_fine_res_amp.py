'''
Amplitude (gain) Rabi -- Sinc pulse -- ARQICK (ARTIQ+QICK) variant
=======================================================================
Same on-chip live-register gain sweep as the QICK-only Sinc
RabiGainFineRes: one fixed-duration Sinc envelope, gain swept via
...
class RabiGainFineRes(NVAveragerProgram):
    '''
    Amplitude (gain) Rabi with a Sinc fine-resolution MW pulse (ARTIQ-triggered readout)
    '''
    required_cfg = [
        "mw_channel",
    ...
    def initialize(self):
        ...
        # Single Sinc envelope at the fixed duration -- amplitude comes
