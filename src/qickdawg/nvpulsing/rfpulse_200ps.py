'''
Simple pulse with envelope at 200ps res
=======================================================================
...
class MWPulseFineRes(NVAveragerProgram):
    '''
    ...
    required_cfg = [        
        ...
        "mode_config", # "oneshot" or "periodic"
    ]
    ...
    def body(self):
        ...
        self.set_pulse_registers(ch=self.cfg.mw_channel, waveform="pulse", mode=self.cfg.mode_config)
